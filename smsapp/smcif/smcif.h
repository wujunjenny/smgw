// SmcIF.h: interface for the SmcIF class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(_SMCIF_H_INCLUDED_)
#define _SMCIF_H_INCLUDED_
...
public:
    ...
    //服务端接口
    CSmcIF(HANDLE hDrvObject, UL Type,UL InterfaceID);
    
    //客户端接口
    CSmcIF(CConnPoint *pAccount, DWORD dwCodeType, DWORD dwDrvType, LPCTSTR pDrvParam, 
...
#endif // !defined(_SMCIF_H_INCLUDED_)
