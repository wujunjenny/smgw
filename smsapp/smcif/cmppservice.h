// cmppservice.h: interface for the CMPPService class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(_CMPPSERVICE_H_INCLUDED_)
#define _CMPPSERVICE_H_INCLUDED_
...
class CCmppService : public CService  
{
public:
    ...
    //服务端接口
    CCmppService(HANDLE hDrvObject, UL Type,UL InterfaceID);
    
    //客户端接口
    CCmppService(CConnPoint *pAccount, DWORD dwCodeType, DWORD dwDrvType, LPCTSTR pDrvParam, 
	    LPCTSTR pIFName, LPCTSTR pPassword, UL ulIFID, UL  ulIFType, LPCTSTR pLocalAddr);
    
	virtual ~CCmppService();
...
#endif // !defined(_CMPPSERVICE_H_INCLUDED_)
