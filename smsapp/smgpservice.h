// smgpservice.h: interface for the SMGPService class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(_SMGPSERVICE_H_INCLUDED_)
#define _SMGPSERVICE_H_INCLUDED_
...
class CSmgpService : public CService  
{
public:
    ...
    //服务端接口
    CSmgpService(HANDLE hDrvObject, UL Type,UL InterfaceID);
    
    //客户端接口
    CSmgpService(CConnPoint *pAccount, DWORD dwCodeType, DWORD dwDrvType, LPCTSTR pDrvParam, 
	    LPCTSTR pIFName, LPCTSTR pPassword, UL ulIFID, UL  ulIFType, LPCTSTR pLocalAddr);
    
	virtual ~CSmgpService();
...
#endif // !defined(_SMGPSERVICE_H_INCLUDED_)
