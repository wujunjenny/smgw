// ptopservice.h: interface for the PToPService class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(_PTOPSERVICE_H_INCLUDED_)
#define _PTOPSERVICE_H_INCLUDED_
...
class CPtopService : public CService  
{
public:
    ...
    //服务端接口
    CPtopService(HANDLE hDrvObject, UL Type,UL InterfaceID);
    
    //客户端接口
    CPtopService(CConnPoint *pAccount, DWORD dwCodeType, DWORD dwDrvType, LPCTSTR pDrvParam, 
	    LPCTSTR pIFName, LPCTSTR pPassword, UL ulIFID, UL  ulIFType, LPCTSTR pLocalAddr);
    
	virtual ~CPtopService();
